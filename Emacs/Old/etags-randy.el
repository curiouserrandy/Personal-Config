...
;;;###autoload
(defvar find-tag-hook-pre nil
  "*Hook to be run by \\[find-tag] before finding a tag.  See `run-hooks'.
The value in the buffer in which \\[find-tag] is done is used,
not the value in the buffer \\[find-tag] goes to.")
...
See documentation of variable `tags-file-name'."
  ...
  ;; Randy added hack:
  ;; Run a pre-tags hook before doing any other processing.
  (run-hooks 'find-tag-hook-pre)
