...
(defconst chrome-issue-list-url-format-string
    "http://code.google.com/p/chromium/issues/list?can=1&q=%s&colspec=ID+Stars+Pri+Area+Feature+Type+Status+Summary+Modified+Owner+M+OS&x=mstone&y=area&cells=tiles"
